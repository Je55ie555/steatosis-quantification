...
parser.add_argument( '--max-distance', required=True, help="How far apart nuclei can be located apart and still be considered neighbors. In micrometers. Default: 15 µm.", type=int, default=15)
...
run_CCA(base_path = args.data_dir, 
